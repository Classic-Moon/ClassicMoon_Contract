...
use classic_classicmoon::mock_querier::mock_dependencies;

use classic_bindings::TerraMsg;
use classic_classicmoon::asset::{Asset, AssetInfo, PairInfo};
use classic_classicmoon::pair::ExecuteMsg as PairExecuteMsg;
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        classicmoon_factory: "classicmoonfactory".to_string(),
    };
    ...
    assert_eq!("classicmoonfactory", config.classicmoon_factory.as_str());
}
    ...
    assert_eq!(
        ...
        vec![
            ...
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                funds: vec![],
                msg: to_binary(&ExecuteMsg::ExecuteSwapOperation {
                    operation: SwapOperation::ClassicmoonSwap {
                        offer_asset_info: AssetInfo::NativeToken {
                            denom: "ukrw".to_string(),
                        },
                        ask_asset_info: AssetInfo::Token {
...
fn query_buy_with_routes() {
    ...
    assert_eq!(
        ...
        SimulateSwapOperationsResponse {
            amount: Uint128::from(952380u128)
        }
    );
}
...
fn query_reverse_routes_with_from_native() {
    ...
    let msg = QueryMsg::ReverseSimulateSwapOperations {
        ...
        operations: vec![SwapOperation::ClassicmoonSwap {
            offer_asset_info: AssetInfo::NativeToken {
                denom: "ukrw".to_string(),
            },
            ask_asset_info: AssetInfo::Token {
