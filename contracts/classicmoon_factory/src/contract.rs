use classic_classicmoon::querier::{query_balance, query_pair_info_from_pair};
...
use classic_classicmoon::asset::{Asset, AssetInfo, AssetInfoRaw, PairInfo, PairInfoRaw};
use classic_classicmoon::factory::{
...
use classic_classicmoon::util::migrate_version;
use protobuf::Message;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:classicmoon-factory";
...
pub fn execute_update_config(
    ...
    if let Some(owner) = owner {
        ...
        let _ = Addr::unchecked(owner.clone());
        config.owner = deps.api.addr_canonicalize(&owner)?;
        //TODO: let _ = deps.api.addr_validate(&owner)?;
        //TODO: config.owner = deps.api.addr_canonicalize(&owner)?;
    }
