...
use classic_classicmoon::querier::{query_balance, query_pair_info, query_token_balance};
use classic_classicmoon::router::SwapOperation;
        ...
        SwapOperation::ClassicmoonSwap {
            ...
            let amount = match offer_asset_info.clone() {
                ...
                AssetInfo::Token { contract_addr } => {
                    query_token_balance(
                        &deps.querier,
                        //TODO: deps.api.addr_validate(contract_addr.as_str())?,
